...
DATABASES = {
    'default': {
        ...
        'NAME': 'jnp3',                      # Or path to database file if using sqlite3.
        'USER': 'jnp3',                      # Not used with sqlite3.
        'PASSWORD': 'jnp3',                  # Not used with sqlite3.
...
SECRET_KEY = 'b$**7q&0$!648(5h8k3ws@y+=qn_qr@59%@c+j$a!_i_+phoi8'
...
UNPROCESSED_PHOTOS_DIR = 'photos'
PROCESSED_PHOTOS_DIR = 'thumbnails'

SPHINX_INDEX = 'photos_idx'
SPHINX_PORT = 9312

MOGILEFS_DOMAIN = 'mogile'
